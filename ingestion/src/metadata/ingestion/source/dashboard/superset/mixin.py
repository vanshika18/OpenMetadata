...
from metadata.ingestion.source.dashboard.superset.models import (SupersetDatasource,DashboradResult,
                                                                 DataSourceResult)
...
class SupersetSourceMixin(DashboardServiceSource):
    ...
    def _get_datamodel(self, datamodel: SupersetDatasource) -> Optional[DashboardDataModel]:
        """
